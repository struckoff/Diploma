...
```
Error: boo!
    at explode (/path/to/test_room.js:3:11)
    at _fulfilled (/path/to/test_room.js:q:54)
...
Error: boo!
    at explode (/path/to/test_room.js:3:11)
From previous event:
    at theDepthsOfMyProgram (/path/to/test_room.js:2:16)
    at Object.<anonymous> (/path/to/test_room.js:7:1)
```
